...
const (
	Auth_Registr_FullMethodName = "/auth.Auth/Registr"
...
func (c *authClient) Registr(ctx context.Context, in *RegistrRequest, opts ...grpc.CallOption) (*RegistrResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegistrResponse)
	err := c.cc.Invoke(ctx, Auth_Registr_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) Registr(context.Context, *RegistrRequest) (*RegistrResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Registr not implemented")
}
...
func _Auth_Registr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_Registr_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Registr(ctx, req.(*RegistrRequest))
	}
